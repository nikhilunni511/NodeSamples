 ...
 * @author TonyGuu
 * 
 * Complex.js: This file defines a Complex class to represent complex numbers.
 */

/*
 * This ‘constructor function’ defines the instance fields r and i on every
 * instance it creates. These fields hold the real and imaginary parts of the
 * complex number: they are the state of the object.
 */
...
/*
 * The ‘instance methods’ of a class are defined as function-valued properties of
 * the prototype object. The methods defined here are inherited by all instances
 * and provide the shared behavior of the class. Note that JavaScript instance
 * methods must use the this keyword to access the instance fields.
 */
...
/*
 * ‘Class fields’ (such as constants) and class methods are defined as properties
 * of the constructor. Note that class methods do not generally use the this
 * keyword: they operate only on their arguments.
 */
